...
<head>
  ...
  <title>Fleet Mgt System | <?php echo $title?></title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url()?>stockitem/manage" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url()?>vendor/manage" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                Vendors
              </p>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url()?>vehicle/manage" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                Vehicle
              </p>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url()?>requesttype/create" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                Request Type
              </p>
