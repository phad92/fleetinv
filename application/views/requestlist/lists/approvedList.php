            ...
            <div class="card card-default">
              ...
              <form action="post">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php //if(!has_current_status($request->id, $status)): ?>
                  <tr>
                    ...
                    <td>
                        <a href="<?php echo base_url()?>requestlist/receiveRequest/<?php echo $request->id?>" class="btn btn-xs btn-info">Receive Request</a>
                    </td>
